          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection>
              <div className="relative">
                ...
                />
                <div className="absolute -bottom-8 -right-8 bg-primary text-primary-foreground p-8 rounded-xl shadow-premium-md">
                  <span className="font-heading text-8xl font-bold">Achieving Excellence</span>
