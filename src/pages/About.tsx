      ...
      <section className="pt-32 pb-16 bg-gradient-to-b from-muted to-background">
        <div className="container-wide mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <SectionHeading
              badge="About Us"
              title="Your Trusted Healthcare Service Partner Since 2018"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection>
              <div className="relative">
                ...
                />
                <div className="absolute -bottom-3 -right-3 bg-primary text-primary-foreground p-3 rounded-xl shadow-premium-md">
                  <span className="font-heading text-3xl font-bold">Achieving Excellence</span>
