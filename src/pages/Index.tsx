  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Malaysia's leading hospital linen supplier, medical uniform manufacturer, and healthcare textile solutions provider. Premium quality surgical gowns, scrubs, hotel linen since 2018."
        />
        <meta
          name="keywords"
          content="hospital linen supplier Malaysia, medical uniform manufacturer Malaysia, hotel linen wholesale, healthcare textile distributor, hospital bedding supplier, surgical gown manufacturer, scrubs supplier Malaysia"
        />
        ...
        <div className="container-wide mx-auto">
          <AnimatedSection>
            <SectionHeading
              ...
              subtitle="Delivering excellence in hospital linen, medical uniforms, and hospitality textiles since 2018"
            />
          </AnimatedSection>
          <AnimatedSection delay={100}>
            <div className="max-w-4xl mx-auto">
              <p className="font-body text-lg text-muted-foreground text-center leading-relaxed mb-8">
                Medisure Healthcare Sdn. Bhd. is a leading provider of 360° hospital linen solutions, 
                medical uniforms, OT gowns, healthcare textiles, and hotel linen essentials. Since 2018, 
                we have supported hospitals, clinics, hotels, and healthcare organizations across Malaysia 
                with premium-quality textiles, hygiene-driven fabrics, and professional-grade uniforms.
              </p>
